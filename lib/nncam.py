...
NNCAM_FLAG_GIGE                = 0x0000200000000000  # GigE
NNCAM_FLAG_10GIGE              = 0x0000400000000000  # 10 Gige
...
NNCAM_OPTION_NOFRAME_TIMEOUT        = 0x01       # no frame timeout: 0 => disable, positive value (>= 500) => timeout milliseconds. default: disable
...
NNCAM_OPTION_NOPACKET_TIMEOUT       = 0x2b       # no packet timeout: 0 = disable, positive value = timeout milliseconds. default: disable
...
NNCAM_BANDWIDTH_DEF            = 90       # bandwidth
...
NNCAM_TEC_TARGET_MIN           = -300     # TEC target: -30.0 degrees Celsius
...
NNCAM_NOPACKET_TIMEOUT_MIN     = 500      # 500ms
NNCAM_NOFRAME_TIMEOUT_MIN      = 500      # 500ms
...
class Nncam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 53.21522.20221011"""
        cls.__initlib()
    ...
    def HotPlug(cls, fun):
        ...
        if sys.platform == 'win32' or sys.platform == 'android':
            ...
            if cls.__hotplug is None:
                ...
                cls.__lib.Nncam_HotPlug(cls.__HOTPLUG_CALLBACK(cls.__hotplugCallbackFun), None)
    ...
    def Flush():
        """Flush is obsolete, it's a synonyms for put_Option(h, NNCAM_OPTION_FLUSH, 3)"""
    ...
    def Update(cls, camId, filePath, pFun):
        ...
        cls.__progress = pFun
        if sys.platform == 'win32':
            return cls.__lib.Nncam_Update(camId, filePath, cls.__PROGRESS_CALLBACK(cls.__progressCallbackFun), None)
        else:
            return cls.__lib.Nncam_Update(camId.encode('ascii'), filePath.encode('ascii'), cls.__PROGRESS_CALLBACK(cls.__progressCallbackFun), None)
